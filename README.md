...
- **Spinoff Platform** - Full-stack application with separate frontend, backend, and mobile app using TypeScript
- **Face-Blocker** - Browser extension for enhanced privacy and control
